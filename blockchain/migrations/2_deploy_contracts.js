...
module.exports = async (deployer, network) => {
  ...
  await deployer.deploy(RadPanda, proxyRegistryAddress, {gas: 4500000});
  await deployer.deploy(RadPandaFactory, proxyRegistryAddress, RadPanda.address, {gas: 2000000});
